...
## Running the model
To run the model you need to input a *formula* and a *dataset*. This example uses the dataset *iris*, which is standard include in R. The model is of the form y~x, where y is the Sepal length depending on the x, the petal length.
